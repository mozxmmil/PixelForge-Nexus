...
export default function SettingsPage() {
  ...
  <div className="flex flex-col justify-center">
    <h1 className="font-bold text-xl text-gray-900 dark:text-white">Name</h1>
    <p className="text-gray-500 dark:text-gray-400 text-sm">mozammel@gmail.com</p>
  </div>
</div>
						<div className="flex gap-4 justify-between items-center bg-white dark:bg-zinc-800 p-4 rounded-lg shadow-sm">
  <h1 className="font-bold text-xl text-gray-900 dark:text-white">Theme</h1>
